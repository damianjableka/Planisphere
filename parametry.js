...
rozmiar_czcionki_nazwy:1.8,//xres* 1.7/(180+2*45) // normalizowany stopien
rozmiar_czcionki_jasnych:1.4,
rozmiar_czcionki_rozwnolezniki:1.3,//// normalizowany stopien
rozmiar_czcionki_poludniki:1.4,// normalizowany stopien
rozmiar_mglawic:0.3,// normalizowany stopien
mglawice_grubosc_linii:2.4,//1.1,//
rozmiar_czcionki_mglawic:1.3,
rozmiar_gwiazd:1.1,
grubosc_granice:6.2,
rysunki_grubosc:6.2,
rownik_grubosc:8.2,
...
skala_roczna:{	szerokosc:20, //stopnie
				...
				tiki:{
					...
					grubosc:{
						...
						dziesiec:function(){return parametry.skala_roczna.stroke*0.8}, //3/4
						piec:function(){return parametry.skala_roczna.stroke*0.75}, //2
						zwykly:function(){return parametry.skala_roczna.stroke*0.5}, //4
							}
...
kolory:{tlo_kwadrat:'#ffffff',//kwadrat- œcinki z mapy
		...
		tlo_mapy: '#25376e',//'#1a274e',//'#051031', 1d274d
		DM: '#49578f',//'#343e66',//'#3c4775',//'#6b75a8',//'#17244d',
		rysunki: '#525252',//'#154e03',
		granice: '#989db0',//'#444488',
		tiki_skali_rocznej: '#444444',
		rownik: '#3333ff',
		...
		tiki_horyzontu: '#3bff00',//'#37c90a',
		czcionak_kierunku: '#3bff00',//'#37c90a',
		czcionak_azymut: '#3bff00',//'#37c90a',
		rownik:"#0b87ab",
		obrys_menu:"#445796",
